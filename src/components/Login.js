            ...
            <div id="login-page">
                <div className='jumbotron'>
                    ...
                    <Modal show={showNoLogin} onHide={handleCloseNoLogIn} centered>
                        ...
                        <Modal.Body>
                            <p>Clicking below will take you to an older version of the website, at subdomain 'nologin.bfi250.com'.</p>
                            <p>This site only displays the 2012 set of films, and will save your activity to your browser's local storage.</p>
                            <Form>
                                <Button className="btn btn-primary btn-lg btn-block btn-link" id="nologin-button" href="https://nologin.bfi250.com/" target="_blank" rel="noreferrer">Go to: nologin.bfi250.com</Button>
                                <Button className="btn btn-primary btn-lg btn-block" variant="primary" onClick={handleCloseNoLogIn}>Cancel</Button>
                            </Form>
                        </Modal.Body>
                    </Modal>
